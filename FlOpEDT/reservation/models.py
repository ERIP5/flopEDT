...
class Reservation(models.Model):
    ...
    Period_choice = models.CharField(max_length=99)
    each_week_choice = models.CharField(max_length=99,choices=each_week_ch, blank = True, help_text="Only required if 'periodicity' is selected")
